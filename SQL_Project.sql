...
INSERT INTO `cmt` VALUES (17,1,'HS001','BLA BLE BLO','2017-06-21 14:04:00'),(18,1,'HS002','BLA BLE BLO 1','2017-06-21 14:04:00'),(19,1,'HS001','BLA BLE BLO 2','2017-06-21 14:04:00'),(20,1,'HS002','BLA BLE BLO 3','2017-06-21 14:04:00'),(21,1,'HS001','BLA BLE BLO 4','2017-06-21 14:04:00'),(22,1,'HS002','BLA BLE BLO D','2017-06-21 14:04:00'),(23,1,'HS001','BLA BLE BLO','2017-06-21 14:04:00'),(24,1,'HS002','BLA BLE BLO','2017-06-21 14:04:00'),(25,1,'HS001','BLA BLE BLO','2017-06-21 14:04:01'),(26,1,'HS002','BLA BLE BLO','2017-06-21 14:04:01'),(27,1,'HS001','BLA BLE BLO','2017-06-21 14:04:01'),(28,1,'HS002','BLA BLE BLO','2017-06-21 14:04:01'),(29,1,'HS001','BLA BLE BLO','2017-06-21 14:04:01'),(30,1,'HS002','BLA BLE BLO','2017-06-21 14:04:01'),(31,1,'HS001','BLA BLE BLO','2017-06-21 14:04:01');
...
CREATE TABLE `hocsinhlop` (
  ...
  PRIMARY KEY (`MA_HS`,`MA_LOP`,`NAMHOC`),
  KEY `FK_HSLOP` (`MA_LOP`),
...
INSERT INTO `topic` VALUES (1,'HS004',1,'2017-06-21 13:52:18','TRUONG CHAY','TRUONG CHAY NEN BO CHO CHUNG MAY NGHI',15);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_infostd` AS select `hsl`.`MA_HS` AS `MA_HS`,`hs`.`TEN_HS` AS `TEN_HS`,`hs`.`NGAY_SINH` AS `NGAY_SINH`,`hs`.`GIOI_TINH` AS `GIOI_TINH`,`hsl`.`MA_LOP` AS `MA_LOP`,`hs`.`MA_TRUONG` AS `MA_TRUONG`,`hs`.`QUE_QUAN` AS `QUE_QUAN`,`hs`.`SO_DT` AS `SO_DT`,`hs`.`USERNAME` AS `USERNAME` from (`hocsinhlop` `hsl` join `hocsinh` `hs` on((`hs`.`MA_HS` = `hsl`.`MA_HS`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-06-22  0:44:28
